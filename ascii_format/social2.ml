...
let subsets_2 b =
  match GeneralProperties.coq_In_dec (S O) b with
    | Left -> Inleft (Inleft (Inleft (Inleft (Inleft (Inleft
        (match GeneralProperties.coq_In_dec (S (S O)) (NatSet.remove (S O) b) with
           | Left -> Inleft (Inleft Left)
           | Right ->
               (match GeneralProperties.coq_In_dec (S (S (S O)))
                        (NatSet.remove (S O) b) with
                  | Left -> Inleft (Inleft Right)
                  | Right ->
                      (match GeneralProperties.coq_In_dec (S (S (S (S O))))
                               (NatSet.remove (S O) b) with
                         | Left -> Inleft Inright
                         | Right ->
                             (match GeneralProperties.coq_In_dec (S (S (S (S
                                      (S O))))) (NatSet.remove (S O) b) with
                                | Left -> Inright
    ...
    | Right ->
        (match GeneralProperties.coq_In_dec (S (S O)) b with
           | Left ->
               (match GeneralProperties.coq_In_dec (S (S (S O)))
                        (NatSet.remove (S (S O)) b) with
                  | Left -> Inleft (Inleft (Inleft (Inleft (Inleft
                      Inright))))
                  | Right ->
                      (match GeneralProperties.coq_In_dec (S (S (S (S O))))
                               (NatSet.remove (S (S O)) b) with
                         ...
                         | Right ->
                             (match GeneralProperties.coq_In_dec (S (S (S (S
                                      (S O))))) (NatSet.remove (S (S O)) b) with
                      ...
                      (match GeneralProperties.coq_In_dec (S (S (S (S O))))
                         ...
                         | Right ->
                             (match GeneralProperties.coq_In_dec (S (S (S (S
                                ...
                                | Right -> assert false (* absurd case *)))
                  | Right ->
                      (match GeneralProperties.coq_In_dec (S (S (S (S O)))) b with
                         | Left ->
                             (match GeneralProperties.coq_In_dec (S (S (S (S
                                      (S O)))))
                                      (NatSet.remove (S (S (S (S O)))) b) with
                                | Left -> Inright
                                | Right -> assert false (* absurd case *))
                         | Right -> assert false (* absurd case *))))
